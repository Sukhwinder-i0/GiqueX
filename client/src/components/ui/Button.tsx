...
const variantStyles: Record<Variants, string> = {
  primary: 'text-xs md:text-sm text-white hover:text-gray-300 border backdrop-blur-md shadow-lg border-white/20 hover:bg-white/20 transition duration-300',
  secondary: "bg-purple-300 text-xs md:text-sm hover:bg-purple-100 hover:shadow-gray-500 rounded-md text-sm text-black",
